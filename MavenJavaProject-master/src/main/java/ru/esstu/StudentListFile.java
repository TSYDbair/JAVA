...
public class StudentListFile implements StudentList {
    ...
    private Student loadFromFile(File file) {
        try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
            String id=null, firstName=null, lastName=null, partonymicName=null, group=null;
            String line;
    ...
    private void saveToFile(Student student) {
        String fileName = directory + File.separator + student.getId() + ".txt";
    ...
    private void deleteFile(String id) {
        String fileName = directory + File.separator + id + ".txt";
